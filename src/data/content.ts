...
export const content: Record<string, Content> = {
  id: {
      ...
      items: [
        {
          ...
          imageUrl: "/src/assets/Frame01.png",
          audioUrl: "/src/assets/audio-id/audio-1-id.mp3",
          duration: "0:57",
        },
        {
          id: "map",
          ...
          imageUrl: "/src/assets/Frame02.png",
          audioUrl: "/src/assets/audio-id/audio-2-id.mp3",
          duration: "7:15",
        },
        {
          id: "artifacts",
          ...
          imageUrl: "/src/assets/Frame03.png",
          audioUrl: "/src/assets/audio-id/audio-3-id.mp3",
          duration: "4:45",
        },
        {
          id: "ethics",
          ...
          imageUrl: "/src/assets/Frame04.png",
          audioUrl: "/src/assets/audio-id/audio-4-id.mp3",
          duration: "8:20",
        },
      ],
    },
    narrative: {
      ...
      imageUrl: "/src/assets/tentangkami.png",
    },
    collaboration: {
      ...
      items: [
        {
          ...
          imageUrl: "/src/assets/Frame01.png",
          audioUrl: "/src/assets/audio-en/audio-1-en.mp3",
          duration: "0:57",
        },
        {
          id: "map",
          ...
          imageUrl: "/src/assets/Frame02.png",
          audioUrl: "/src/assets/audio-en/audio-2-en.mp3",
          duration: "7:15",
        },
        {
          id: "artifacts",
          ...
          imageUrl: "/src/assets/Frame03.png",
          audioUrl: "/src/assets/audio-en/audio-3-en.mp3",
          duration: "4:45",
        },
        {
          id: "ethics",
          ...
          imageUrl: "/src/assets/Frame04.png",
          audioUrl: "/src/assets/audio-en/audio-4-en.mp3",
          duration: "8:20",
        },
      ],
    },
